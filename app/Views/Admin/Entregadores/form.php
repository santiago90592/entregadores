...
<div class="form-row">
 ...
 <div class="form-group col-md-4">
     <label for="carta de conducao">carta de conducao</label>
     <input type="text" class="form-control" name="carta de conducao" id="carta de conducao" value="<?php echo old('carta de conducao', esc($entregador->cartadeconducao)); ?>">
 </div>
